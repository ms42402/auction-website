...
try
{
	...
	*/
	...
	rs1 = st1.executeQuery("select b.item_ID from bids b, item i where i.categories = '" + category + "' and b.item_ID = i.item_ID"); 
	rs2 = st2.executeQuery("select b.price from bids b, item i where i.categories = '" + category + "' and b.item_ID = i.item_ID");
	...
	while(rs1.next() && rs2.next()){
		...
		rs6 = st6.executeQuery("select categories from item where item_ID = '" + ID + "'");
