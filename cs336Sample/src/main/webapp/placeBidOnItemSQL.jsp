...
try
{
	...
	rs1 = st1.executeQuery("select names from item"); 
	rs2 = st2.executeQuery("select dates from item");
	rs3 = st3.executeQuery("select times from item");
	rs4 = st4.executeQuery("select initial_price from item");
...

{
 ...
 <form method="post" action="sellerViewPastAuctionSQL.jsp">
      ...
      <!--  <a href="buyerHomePage.jsp">  -->
       <p> Input the item ID of the item you want to bid on: <input type= "number" name="item_ID"> 
