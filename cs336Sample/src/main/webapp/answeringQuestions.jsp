...
<html>
   ...
   <body>
      ...
      <h1><FONT COLOR="#0d7e7c"> <strong> Answering Questions </strong> </h1> </Font> <br/>
...
try
{
	...
	rs1 = st1.executeQuery("select question from q_a where answer is null"); 
	...
	while(rs1.next()){
      ...
      session.setAttribute("question", rs1.getString(1));


%> 

  
     <form method="post" action="answeringQuestionSQL.jsp">
             
   <p>Answer Question: <input type= "text" name="key"> 
