...
<html>
   ...
   <body>
    ...
    <!--Creates a form that the admin needs to fill out, the input values can be referred to by what is written in name -->
     <form action="adminCreateAuction.jsp" method="POST">
       ...
       <table>
  <tr>
    <td><input type="radio" name="kitchen" value="kitchen"></td>
    <td>Kitchen</td>
  </tr>
  <tr>
    <td><input type="radio" name="laundry" value="laundry"></td>
    <td>Laundry</td>
  </tr>
  <tr>
    <td><input type="radio" name="personalUse" value="personalUse"></td>
    <td>Personal Use </td>
  </tr>
</table>
